    ...
    if request.method=='POST':
        ...
        if number==20:
            ...
            if score>=12:
                ...
                context={'win': 'True',
                'mark':mark,
                'text': 'Молодец, ты прошел тест, теперь ты приглашен на день Рождения. Девятнадцатый день рождения Тимофея пройдет 22 июня в 19:00 а ресторане Dr. Живаго. Буду тебя ждать ❤️'}
